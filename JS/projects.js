...
let tailwind_icon = {
  title: "Tailwind",
  img_link: "./Assets/Icons/tailwind.svg",
};

let redux_icon = {
  title: "Redux",
  img_link: "./Assets/Icons/redux.svg",
};

let express_icon = {
  title: "Express",
  img_link: "./Assets/Icons/express.svg",
};

let nodejs_icon = {
  title: "NodeJS",
  img_link: "./Assets/Icons/nodejs.svg",
};
...
const projects = {
  project9: {
    title: "Reel Sleuth",
    description:
      "A website where you can search for movies, add them to your wishlist, keep track of what you've watched, and mark your favorites.",
  ...
  project8: {
    ...
    description:
      "This is the updated version of the Chess Player Stats Repo I made earlier. Displays, the current rating, best rating and number of games played in each category, namely - Bullet, Blitz and Rapid",
    ...
    website_link:
      "https://vignesh-venkatesh.github.io/ChessPlayerStatsUpdated/",
  ...
  project7: {
    title: "Etch A Sketch",
    description:
      'As part of "The Odin Project" bootcamp, we were supposed to create an Etch-A-Sketch application as part of one of our projects. It helped me understand how event listeners in Javascript worked.',
  ...
  project6: {
    ...
    description:
      "Using the built-in Canvas API and WebAudio API from Javascript to display music visualizations. Future updates might include a 3D visualizer using Three.js",
    technologies: [
      html_icon,
      css_icon,
      js_icon,
  ...
  project5: {
    ...
    description:
      'As part of "The Odin Project" bootcamp, we were supposed to create a Rock, Paper, Scissors game as part of one of our projects. It helped me understand how Flexbox and DOM Manipulation worked',
    technologies: [html_icon, css_icon, js_icon],
    github_link:
      "https://github.com/Vignesh-Venkatesh/odin-rock-paper-scissors",
    website_link:
      "https://vignesh-venkatesh.github.io/odin-rock-paper-scissors/",
    blog_link: null,
  ...
  project4: {
    ...
    description:
      "A small project to test my HTML, CSS, JS skills. Used the in built-in audio API to load in the tones for the keys.",
    technologies: [html_icon, css_icon, js_icon],
  ...
  project2: {
    title: "Spotify EDA",
    description:
      "Conducted an Exploratory Data Analysis on the Spotify Dataset and understood trends and insights.",
  ...
  project1: {
    ...
    description:
      "Created a School Library Management System which includes both, admin and student UI on the command line",
    technologies: [python_icon, mysql_icon],
    github_link:
      "https://github.com/Vignesh-Venkatesh/SchoolLibraryManagementSystem",
    website_link: null,
    blog_link: null,
...
function getProjects(value) {
  ...
  for (const project in projects) {
    const technologyTitles = projects[project].technologies.map(
      (tech) => tech.title
    );
...
function displayProjects(value) {
  const project_section_panel = document.getElementById(
    "project-section-panels"
  );
    ...
    content.innerHTML = `
                            <div class = "project-panel">
                                <div class = "project-panel-side-1">
                                    <!-- image/gif -->
                                    <img src="${
                                      projects[project].image_gif
                                    }" alt="">
                                    <!-- links -->
                                    ${generateLinks(
                                      projects[project].github_link,
                                      projects[project].website_link,
                                      projects[project].blog_link,
                                      link_div
                                    )}
                                </div>
                                ...
                                <div class = "project-panel-side-2">
                                    ...
                                    }</h1> <!-- Use projects[project] here as well -->
                                    <!-- Project Description -->
                                    <p>${projects[project].description}</p>
                                    <!-- Technologies Used -->
                                    ${generateTechnologiesDiv(
